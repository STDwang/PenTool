        ...
        Column{
            ...
            Item{
                ...
                TIconButton{
                    ...
                    onClicked: newsatedia.hideAndClose();
                }
            }
            ...
            Row {
                ...
                TInputField{
                    ...
                    placeholderPosition: TPosition.Left;
                    placeholderLabel.text: "请输入轨道高度(km)";
                    placeholderLabel.color: labelColor
                    border.color: borderColor
                    border.width: 0
            ...
            Row {
                ...
                TInputField{
                    ...
                    placeholderPosition: TPosition.Left;
                    placeholderLabel.text: "请输入距离(km)";
                    placeholderLabel.color: labelColor
                    border.color: borderColor
                    border.width: 0
            ...
            Row {
                ...
                TIconButton{
                    ...
                    onClicked: {
                        console.log("添加文件")
                        TToast.showSuccess("添加成功",TTimePreset.LongTime4s, "文件保存在" + global.xlsxDir);
                    }
                }
            }
            ...
            Row {
                ...
                TButton{
                    ...
                    onClicked: {
                        ...
                        penToolSever.addSate(sateFormData);
                        newsatedia.close();
