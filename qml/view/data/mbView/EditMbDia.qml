        ...
        Column{
            ...
            Item{
                ...
                TIconButton{
                    ...
                    backgroundComponent: null;
                    anchors.right: parent.right;
                    onClicked: editdia.hideAndClose();
                }
            }
        ...
        Row {
            ...
            TButton{
                ...
                onClicked: {
                    ...
                    penToolSever.editMb(mbFormData);
                    editdia.close();
